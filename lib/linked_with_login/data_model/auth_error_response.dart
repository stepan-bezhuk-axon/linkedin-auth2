...
AuthorizationErrorResponse authorizationErrorResponseFromJson(String str) =>
    AuthorizationErrorResponse.fromJson(json.decode(str));
...
enum LinkedInAuthErrorType { userCancelledLogin, userCancelledAuthorize, other }
